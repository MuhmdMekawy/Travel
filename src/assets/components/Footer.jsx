        ...
        <div className="container">
          <div className="top">
            <div className="content">
              <div className="cont">
                <div className="logo"><img src={logo} alt="logo" loading='lazy' /></div>
                <p>Travel helps companies <br /> manage payments easily.</p>
                <div className="links">
                  <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <g clipPath="url(#clip0_0_659)">
                        <path d="M19.9951 20.0008V20H20.0001V12.665C20.0001 9.07667 19.2276 6.3125 15.0326 6.3125C13.0159 6.3125 11.6626 7.41917 11.1101 8.46833H11.0517V6.6475H7.07422V20H11.2159V13.3883C11.2159 11.6475 11.5459 9.96417 13.7017 9.96417C15.8259 9.96417 15.8576 11.9508 15.8576 13.5V20.0008H19.9951Z"/>
                        <path d="M0.330078 6.64844H4.47675V20.0009H0.330078V6.64844Z"/>
              ...
              <div className="cont">
                ...
                <div className="input">
                  ...
                  <button className="buttonHover">Subscribe</button>
                </div>
          ...
          <div className="bottom">
            <h5>Copyright @ Xpro 2022. All Rights Reserved.</h5>
          </div>
        </div>
      </div>
    </>
